...
namespace WpfApp
{
    public partial class MainWindow : Window
    {
        ...
        private void Create()
        {
            ...
            client.UploadString("https://saftwebapp.azurewebsites.net/odata/Messages", data);
        }

        public List<Message> Retrieve()
        {
            WebClient client = new WebClient();
            string data = client.DownloadString("https://saftwebapp.azurewebsites.net/odata/Messages");
            var result = JsonConvert.DeserializeObject<List<Message>>(data);
            return result;
        }
